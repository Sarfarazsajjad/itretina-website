...
function showNextTab(section) {
  ...
  var activeIndex = Array.from(tabs).findIndex(function (tab) {
...
var more_option = document.getElementById("nav-btn");
var mega_option = document.querySelector(".header-nav");
more_option.addEventListener("click", function (e) {
  e.preventDefault();
