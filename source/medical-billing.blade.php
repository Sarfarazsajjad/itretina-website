...
<div class="container my-5 why-choose-us-container">
    ...
    <div class="row">
        @include('_partials.billing-process',['class'=>'col-md-4','heading' => 'Streamlined Operations','desc'=>'We
        optimize your billing operations to ensure timely and accurate claim submissions, reducing denials
        and accelerating reimbursements.'])
        @include('_partials.billing-process',['class'=>'col-md-4','heading' => 'Experienced Professionals','desc'=>'Our
        team comprises skilled professionals with years of experience in handling diverse medical billing
        needs, ensuring precision at every step.'])
        @include('_partials.billing-process',['class'=>'col-md-4','heading' => 'Advanced
        Technology','desc'=>'Integrating the latest technology, we offer solutions that not only simplify billing
        processes but
...
<section class="container my-5">
    ...
    <div class="row">
        @include('_partials.billing-process',['class'=>'col-md-3','heading' => '1. Patient Verification','desc'=>'We
        begin by verifying patient details to avoid discrepancies in the later stages of billing.'])
        @include('_partials.billing-process',['class'=>'col-md-3','heading' => '2. Claim Creation','desc'=>'Our team
        meticulously creates claims, ensuring all services rendered are accurately coded and
        documented.'])
        @include('_partials.billing-process',['class'=>'col-md-3','heading' => '3. Submission and Tracking','desc'=>'We
        submit claims to the respective insurance companies and track them until they are settled.'])
        @include('_partials.billing-process',['class'=>'col-md-3','heading' => '4. Revenue Collection','desc'=>'Upon
        approval, we ensure prompt collection of payments and handle any denials or discrepancies
        efficiently.'])
    </div>
</section>
...
@include('_partials.bottom-bar-heading-button',['heading'=>'Ready to Transform Your Billing Process?','desc'=>'Join hands with a team that`s committed to your success. Get in touch with us today.','buttonLink'=>'#contact','buttonText'=>'Contact Us'])
</section>
